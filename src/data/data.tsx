    ...
    "AI Engineering": [
      {
        ...
        description:
          "Full-stack AI travel search engine. Type a destination, get a complete guide in under a minute.",
    ...
    "React - Next.js": [
      {
        ...
        description:
          "A React AI Calendar app with reminder management, built with React 19, TypeScript, Vite 8, and the Groq API",
      ...
      },
      {
        ...
        description:
          "A real-time collaborative task board application built with React, TypeScript, TailwindCSS and Socket.io",
  ...
  },
  {
    "Python - Django": [
      ...
      },
      {
        title: "PyScanText",
        description:
          "Streamlit app that extracts text from images using OCR and detects programming languages.",
    ...
    "KDE - QT": [
      {
        ...
        image: "kmail.png",
        github:
          "https://code.google.com/archive/p/google-summer-of-code-2010-kde/downloads",
